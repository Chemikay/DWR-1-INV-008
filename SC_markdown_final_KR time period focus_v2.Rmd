...
This is a R Markdown HTML document to supplement DWR-1-INV-008 Conductivity Investigation Winter 2022 which explores cleaned up data compiled from samples collected between March 2018 and February 2023 that had both field and laboratory derived conductivity reported in the DWR Water Data Library (WDL). Relative percent differences (RPDs) between these field and laboratory reported values are evaluated here. explore relative percent differences (RPD) between DWR field and Bryte Lab specific conductance (SC) measurements. Samples collected between March 2018 and February 2023 are evaluated here. Data were exported from the WDL database. See "lab vs field sc investigation final code_v3.R" script for data cleaning and reorganization.
...
Sample counts and RPDS across time periods 1 & 2 and filtered for above and below 10000 uS/cm
